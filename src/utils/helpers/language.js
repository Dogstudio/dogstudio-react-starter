 ...
 */
export const getLocaleCookie = (cookie = 'REACT_APP_LOCALE') => {
...
export const getFallbackLocale = () => {
  return process.env.APP_FALLBACK_LOCALE || 'en'
}
...
export const getDefaultLocale = () => {
  return process.env.APP_DEFAULT_LOCALE || getFallbackLocale()
}
 ...
 * @param {String} locale - Active locale
 */
export const setLocaleCookies = (locale, cookie = 'REACT_APP_LOCALE') => {
  const supportedLocales = getSupportedLocales()
  const supportedLocalesArray = supportedLocales.split('|')
